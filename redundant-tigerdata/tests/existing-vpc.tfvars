# Redundant-TigerData — Existing VPC
# Usage: tofu -chdir="redundant-tigerdata" plan -var-file="tests/existing-vpc.tfvars" -var-file="tests/secrets.tfvars"

aws_region          = "eu-south-2"
name_prefix         = "test-rd-tiger-ext"
