# Standalone-Atlas — Existing VPC + VPC Peering
# Usage: tofu -chdir="standalone-atlas" plan -var-file="tests/existing-vpc-peering.tfvars" -var-file="tests/secrets.tfvars"

aws_region          = "eu-south-2"
name_prefix         = "test-sa-atlas-extp"
